...
void HttpServer::runServer(quint16 port)
{
    ...
    connect(mServer, SIGNAL(requestReady(Pillow::HttpConnection*)), handlerStack, SLOT(handleRequest(Pillow::HttpConnection*)));
}


HttpClientHandler::HttpClientHandler(QObject *parent):
